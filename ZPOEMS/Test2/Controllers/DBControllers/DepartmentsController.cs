...
namespace Test2.Controllers.DBControllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "DepartmentId,DepartmentName,DepartmentParentId")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "DepartmentId,DepartmentName,DepartmentParentId")] Department department)
        {
            if (ModelState.IsValid)
            {
